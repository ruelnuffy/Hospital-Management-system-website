  ...
  if(isset($_POST['login_btn']))
  {
      ...
      if($result)
      {
        ...
        if( mysqli_num_rows($result)>=1)
        {
            ...
            header("location:../get-ready-master");
        }
       else
       {
...
<head>
  <!-- Design by foolishdeveloper.com -->
    ...
    <!--Stylesheet-->
    <meta name="google-signin-client_id" content="152747365908-lh787dl6o7j78um4m8kk14dfoor94nk7.apps.googleusercontent.com">
    <style media="screen">
      *,
*:before,
*:after{
...
<body>
    ...
    <form method="post" action="index.php" class="tab" style="height: 650px;">
    ...
    {
         echo "<div id='error_msg' style='color:black;'>".$_SESSION['message']."</div>";
...
?></center>
        ...
        <p style="color:black;">Don't Have an Acoount? <a  style="color:black;" href="./register.php">Sign up Here</a></p>

        <div class="g-signin2" data-onsuccess="onSignIn" style="color: black;"><p style="position: ;">Signup</p></div>
    </form>
